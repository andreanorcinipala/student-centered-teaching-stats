...
import { probabilityContent } from "../../../data/probability";
import DiceRoller from "../../../components/interactives/DiceRoller";
...
export default function ProbabilityPage() {
  ...
  const content = probabilityContent[difficulty];
      ...
      <main className="max-w-4xl mx-auto px-6 py-10 space-y-10">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-brand-500 text-lg max-w-xl mx-auto">
            The language of uncertainty. Every statistical test builds on these
            ideas.
          </p>
        </div>
        ...
        <section className="bg-white rounded-2xl border border-brand-100 shadow-sm p-6 md:p-8">
          ...
          <CustomExample topic="Probability" difficulty={difficulty} />
        </section>
      </main>
